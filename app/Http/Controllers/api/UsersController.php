        ...
        try {
            ...
            $transformedResults = $results->getCollection()->map(function ($item) {
                return [
                    ...
                    'image' => $item->image ? (str_starts_with($item->image, 'http') ? $item->image : Config::get('constants.TIPTAP_IMAGE_PATH') . $item->image) : null,
                    'thumbnail' => $item->image ? (str_starts_with($item->image, 'http') ? $item->image : Config::get('constants.TIPTAP_IMAGE_PATH') . $item->image) : null,
