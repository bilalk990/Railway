		...
		<div
			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					...
					<!-- {{ Str::studly($type) }}  -->
					{{ str_replace("-", " ", ucfirst($type)) }} 	 Management </h5>			
					<ul
					...
					<div class="card card-custom card-stretch card-shadowless">
						<div class="card-header">
							...
							<div class="card-toolbar">
								...
								<a href='{{route("$model.add",$type)}}'  class="btn btn-primary"> {{ trans("Add New ") }}{{ str_replace("-", " ", ucfirst($type)) }}  </a>
							</div>
						</div>
						<div class="card-body">
											...
											@if(!$results->isEmpty())
												@foreach($results as $result)
													<tr>
                                                        ...
                                                        @endif
														<a href="{{route($model.'.edit',array($type,base64_encode($result->id)))}}" class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="Edit" data-original-title="Edit">
															...
															<a href="{{route($model.'.delete',['enlokid'=>base64_encode($result->id)])}}" class="btn btn-icon btn-light btn-hover-danger btn-sm confirmDelete" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="Delete" data-original-title="Delete">
                                                            <span class="svg-icon svg-icon-md svg-icon-danger">
                                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                        <rect x="0" y="0" width="24" height="24" />
