...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route($model.'.index')}}" class="text-muted"> {{Config('constants.TEMPLE.TEMPLE_TITLES')}}</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            <form action="{{route('temples.save')}}" method="post" class="mws-form" autocomplete="off" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="col-xl-6">
                                <div class="form-group m-0">
                                    ...
                                    <input type="file" name="image"
                                        ...
                                        value="{{old('image')}}" accept="image/jpeg, image/png, image/gif">
                                    @if ($errors->has('image'))
                                    <div class=" invalid-feedback">
                                        {{ $errors->first('image') }}
                                    </div>
