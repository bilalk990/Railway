                                ...
                                <table class="table dataTable table-head-custom table-head-bg table-borderless table-vertical-center" id="taskTable">
                                    <thead>
                                        <tr class="text-uppercase">
                                         ...
                                         <th class="{{(($sortBy == 'last_login' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'last_login' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                            <a href="{{route($model.'.index',array(	'sortBy' => 'last_login',
                                             'order' => ($sortBy == 'last_login' && $order == 'desc') ? 'asc' : 'desc',	
                                             $query_string))}}"> Last Login</a>
                                         </th>
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="text-dark-75 mb-1 font-size-lg">
                                                {{ !empty($result->last_login) ? date(config("Reading.date_format")." H:i:s",strtotime($result->last_login)) : 'N/A' }}
                                            </div>
                                        </td>
                                        <td>
