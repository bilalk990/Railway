...
<div class="d-flex flex-column-fluid">
    <div class=" container ">
        {{ Form::open(['method' => 'get','role' => 'form','route' => [$model . '.festivalTemples', $festival_id],'class' => 'kt-form kt-form--fit mb-0','autocomplete'=>"off"]) }}
        {{ Form::hidden('display') }}
        <div class="row">
            <div class="col-12">
                <div class="card card-custom card-stretch card-shadowless">
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            ...
                            <a href='{{route("festivals.festivalTempleCreate",[base64_encode($festival_id)])}}' class="btn btn-primary"> {{ trans("Add New Temple") }}</a>
                        </div>
                    </div>
                    <div class="card-body">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <td>                                                   
                                            <a href="{{route($model.'.festivalTempleDestroy',array(base64_encode($result->id)))}}" class="btn btn-icon btn-light btn-hover-danger btn-sm confirmDelete" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="Delete" data-original-title="Delete">
