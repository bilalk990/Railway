   ...
   <div class="d-flex flex-column-fluid">
      <div class=" container ">
        ...
        <div class="form-group row">
            <label class="col-4 col-form-label">States:</label>
            <div class="col-8">
                @if(!empty($festivalDetails->states))
                    ...
                    @endphp
                    <span class="form-control-plaintext font-weight-bolder">{{ implode(', ', $stateNames) }}</span>
                @else
                    <span class="form-control-plaintext font-weight-bolder text-muted">No states assigned</span>
                @endif
            </div>
        </div>
    </div>
