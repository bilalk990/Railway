											...
											<tbody>
												...
												<tr>
													...
													<td class="text-right pr-2">
														<a href="{{route($model.'.edit',base64_encode($record->id))}}" class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="Edit" data-original-title="Edit">
														...
														<a href="{{route($model.'.delete',base64_encode($record->id))}}" class="btn btn-icon btn-light btn-hover-danger btn-sm confirmDelete" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="Delete" data-original-title="Delete">
