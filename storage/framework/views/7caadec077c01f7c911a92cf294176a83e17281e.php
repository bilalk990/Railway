                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="form-group">
                                    <lable name="faq_order">Faq Order</lable><span class="text-danger"> * </span>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="form-group">
                                                    <?php if($i == 1): ?>
                                                    <lable for="<?php echo e($language->id); ?>.question">Question</lable><span class="text-danger"> * </span>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($multiLanguage[$language->id]['question'] ?? old('question')); ?>">
                                            ...
                                            <div class="col-xl-12">
                                                <div class="form-group">
                                                    ...
                                                    <?php if($i == 1): ?>
                                                    <lable>Answer </lable><span class="text-danger"> * </span>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zaz/web/zaz.dev.obdemo.com/public_html/resources/views/admin/faqs/edit.blade.php ENDPATH**/ ?>