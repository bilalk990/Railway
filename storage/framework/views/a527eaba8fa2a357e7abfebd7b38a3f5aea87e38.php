									...
									<table class="table dataTable table-head-custom table-head-bg table-borderless table-vertical-center" id="taskTable">
										<thead>
											<tr class="text-uppercase">
												...
												<th class="<?php echo e((($sortBy == 'msgstr' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'msgstr' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
													<a href="<?php echo e(route($model.'.index',array(	'sortBy' => 'msgstr',
													'order' => ($sortBy == 'msgstr' && $order == 'desc') ? 'asc' : 'desc',	
													$query_string))); ?>">String</a>
												</th>
												<th class="<?php echo e((($sortBy == 'locale' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'locale' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
													<a href="<?php echo e(route($model.'.index',array(	'sortBy' => 'locale',
													'order' => ($sortBy == 'locale' && $order == 'desc') ? 'asc' : 'desc',	
													$query_string))); ?>">Language Code</a>
												</th>
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<div class="text-dark-75 mb-1 font-size-lg">
														<div id="actual_div_<?php echo $results->id; ?>">
															<?php echo e(stripslashes($results->msgstr)); ?>
												...
												<td>
													<div class="text-dark-75 mb-1 font-size-lg">
														<?php echo e($results->locale); ?>

													</div>
												</td>
												<td class="text-right pr-2">
													<a href="<?php echo e(route('language-settings.edit',$results->id)); ?>" class="edit_button btn btn-icon btn-light btn-hover-primary btn-sm" id="edit_<?php echo $results->id ?>" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="Edit" data-original-title="Edit">
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gettransfer/web/gettransfer.stage02.obdemo.com/public_html/resources/views/admin/language-settings/index.blade.php ENDPATH**/ ?>