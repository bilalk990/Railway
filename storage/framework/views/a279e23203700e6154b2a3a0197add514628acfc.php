        ...
        <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    Edit <?php echo e(Config('constants.CATEGORY.CATEGORY_TITLE')); ?></h5>
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="image" accept="image/*" class="form-control form-control-solid form-control-lg">
                                </div>
                            </div>
                            <?php if($catDetails->image): ?>
                            <div class="col-xl-7">
                                <div class="form-group">   
                                    <a class="fancybox-buttons" data-fancybox-group="button" href="<?php echo e(url (Config::get('constants.CATEGORY_IMAGE').$catDetails->image)); ?>"><img height="100" width="100" src="<?php echo e(url (Config::get('constants.CATEGORY_IMAGE').$catDetails->image)); ?>" /></a>
                                    <input type="hidden" name="old_image" class="form-control form-control-solid form-control-lg" value="<?php echo e($catDetails->image ?? ''); ?>">                  
                                </div>
                            </div>
                            <?php endif; ?>
                        </div>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zaz/web/zaz.stage02.obdemo.com/public_html/resources/views/admin/category/edit.blade.php ENDPATH**/ ?>