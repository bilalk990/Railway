										...
										<tbody>
											...
											<tr>
												...
												<td class="text-right pr-2">
													<a href="<?php echo e(route('language-settings.edit',$results->id)); ?>" class="edit_button btn btn-icon btn-light btn-hover-primary btn-sm" id="edit_<?php echo $results->id ?>" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="" data-original-title="Edit">
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zaz/web/zaz.stage02.obdemo.com/public_html/resources/views/admin/language-settings/index.blade.php ENDPATH**/ ?>