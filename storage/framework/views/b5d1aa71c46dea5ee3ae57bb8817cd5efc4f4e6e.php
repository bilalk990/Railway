...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        Edit
                         <?php echo e(Config('constants.CMS_MANAGER.CMS_PAGE_TITLE')); ?> </h5>
    ...
    <div class="d-flex flex-column-fluid">
        <div class="container">
            <form action="<?php echo e(route($modelName.'.update',base64_encode($cmsDetails->id))); ?>" method="POST" class="mws-form" autocomplete="off" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($cmsDetails->page_name ?? old('page_name')); ?>">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="form-group">
                                                    <?php if($i == 1): ?>
                                                    <label for="<?php echo e($language->id); ?>.title">Page Title</label><span class="text-danger"> * </span>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($multiLanguage[$language->id]['title'] ?? old('title')); ?>">
                                                    ...
                                                    <?php else: ?>
                                                    <label for="<?php echo e($language->id); ?>.title">Page Title</label><span class="text-danger"> </span>
                                                    <input type="text" name="data[<?php echo e($language->id); ?>][title]" class="form-control form-control-solid form-control-lg" value="<?php echo e($multiLanguage[$language->id]['title'] ?? old('title')); ?>">
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <div class="col-xl-12">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($multiLanguage[$language->id]['body'] ?? old('body')); ?>">
                                                    <?php echo e($multiLanguage[$language->id]['body'] ?? old('body')); ?> </textarea>
                                                    ...
                                                    <textarea name="data[<?php echo e($language->id); ?>][body]" id="body_<?php echo e($language->id); ?>" class="form-control form-control-solid form-control-lg"><?php echo e($multiLanguage[$language->id]['body'] ?? old('body')); ?></textarea>
                                                    <?php endif; ?>
                                                </div>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gettransfer/web/gettransfer.stage02.obdemo.com/public_html/resources/views/admin/cms-manager/edit.blade.php ENDPATH**/ ?>