            ...
            <div class="card-body px-0">
               <div class="tab-content px-10">
                  <div class="tab-pane active" id="kt_apps_contacts_view_tab_1" role="tabpanel">
                     ...
                     <div class="form-group row my-2">
                        <label class="col-4 col-form-label">Phone_Number:</label>
                        <div class="col-8">
                           <span class="form-control-plaintext font-weight-bolder">   +<?php echo e($modell->phone_number_prefix ?? ''); ?><?php echo e($modell->phone_number ?? ''); ?></span>
                        </div>
                     </div>
                     <div class="form-group row my-2">
                     ...
                     <div class="form-group row my-2">
                        <label class="col-4 col-form-label">Created_On:</label>
                        <div class="col-8">
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zaz/web/zaz.dev.obdemo.com/public_html/resources/views/admin/staff/view.blade.php ENDPATH**/ ?>