                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <!-- <div class="col-lg-3 mb-lg-5 mb-6">
                                                    ...
                                                    <div class="input-group date" data-target-input="nearest">
                                                        <input type="text" class="form-control datetimepicker-input" name="date_from" placeholder="Date From" id="datepickerfrom" value="<?php echo e($searchVariable['date_from'] ?? ''); ?>">
                                                ...
                                                <div class="col-lg-3 mb-lg-5 mb-6">
                                                    <label>Date To</label>
                                                    <div class="input-group date" data-target-input="nearest">
                                                        <input type="text" class="form-control datetimepicker-input" name="date_to" placeholder="Date To" id="datepickerto" value="<?php echo e($searchVariable['date_to'] ?? ''); ?>">
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">
                                                                <i class="ki ki-calendar"></i>
                                                            </span>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gettransfer/web/gettransfer.dev.obdemo.com/public_html/resources/views/admin/staff/index.blade.php ENDPATH**/ ?>