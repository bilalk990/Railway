        ...
        <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    Add New <?php echo e(Config('constants.PRODUCT.PRODUCT_TITLE')); ?> </h5>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name')); ?>">
                                            ...
                                            <div class="col-xl-12">
                                                <div class="form-group">
                                                    <?php if($i == 1): ?>
                                                    <label for="<?php echo e($language->id); ?>.descptions">Description</label><span class="text-danger"> * </span>
                                                    <textarea id="body_<?php echo e($language->id); ?>.descptions" name="data[<?php echo e($language->id); ?>][descptions]" class="form-control form-control-solid form-control-lg  <?php $__errorArgs = ['descptions'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" rows="6"><?php echo e(old('descptions')); ?></textarea>
                                                    <?php if($errors->has('descptions')): ?>
                                                    <div class="invalid-feedback">
                                                        <?php echo e($errors->first('descptions')); ?>

                                                    </div>
                                                    <?php endif; ?>
                                                    <?php else: ?>
                                                    <label for="<?php echo e($language->id); ?>.descptions">Description</label><span class="text-danger"> </span>
                                                    <textarea id="body_<?php echo e($language->id); ?>.descptions" name="data[<?php echo e($language->id); ?>][descptions]" class="form-control form-control-solid form-control-lg "  rows="6"><?php echo e(old('descptions')); ?></textarea>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <?php if(old('subcategory_id')==$subcat->id): ?>
                                        <option  value="<?php echo e($subcat->id); ?>"  <?php echo e(old('subcategory_id') == $subcat->id ? 'selected' : ''); ?>  ><?php echo e($subcat->name); ?></option>
                                        <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>    
                                    </select>
...
unset($__errorArgs, $__bag); ?>"  value="<?php echo e(old('price')); ?>" accept="price/*" placeholder="₱ Price">
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="radio" name="in_stock"  <?php echo e(old('in_stock')==0 ? 'checked' : ''); ?> value="0">
                                    <lable for="in_stock" >In Stock<span class="text-danger">  </span></lable>
                                    <input type="radio" name="in_stock" <?php echo e(old('in_stock')==1 ? 'checked' : ''); ?> checked value="1">
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                             <?php $product_images =  Session::get('uploadsImage') ?? []; ?>
...
unset($__errorArgs, $__bag); ?>" name="cover_image" value="<?php echo e(count($product_images) > 0 ? $product_images[0] : ''); ?>">
                            ...
                            <div class="form-group" id="dropBox">
                                ...
                                <div id="gallery">
                                    ...
                                    <div class="imageBox">
                                        <h3 class="cover_image_add <?php echo e($key == 0 ? 'image_coverdesgin' : ''); ?>"><?php echo e($key == 0 ? 'Cover Photo' : ''); ?></h3>
                                        <input hidden class="image_name_of" name="images[]" value="$<?php echo e($image); ?>">
                                        <img src="<?php echo e(Config('constants.PRODUCT_IMAGE')); ?>/<?php echo e($image); ?>">
                                        <div class="gallery-img-edit">
                                            <a href="javascript:void(0)" data-image="<?php echo e($image); ?>" class="delete_image" data-type-image="session">
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-4">
                                <div class="form-group">
                                    ...
                                    ?>
                                    <select name="product_sizes[0][size_id]" class="form-control form-control-solid form-control-lg  <?php $__errorArgs = ['size_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <option  value="<?php echo e($size->id); ?>"  <?php echo e(old('size_id') == $size->id ? 'selected' : ''); ?>  ><?php echo e($size->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                                     
                                    </select>
                        ...
                        <div class="col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="product_sizes[0][price]" class="form-control form-control-solid form-control-lg "  placeholder="₱ Price">
                                <?php if($errors->has('price')): ?>
                                <div class=" invalid-feedback">
                                    <?php echo e($errors->first('price')); ?>
                        ...
                        <div class="col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="radio" name="product_sizes[0][stock]" id="out_stock" class="" value="0">
                                <lable for="stock" >In Stock<span class="text-danger">  </span></lable>
                                <input type="radio" name="product_sizes[0][stock]" id="stock" value="1" >
                                <?php if($errors->has('in_stock')): ?>
                                <div class="invalid-feedback">
                                    <?php echo e($errors->first('in_stock')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zaz/web/zaz.stage02.obdemo.com/public_html/resources/views/admin/product/add.blade.php ENDPATH**/ ?>