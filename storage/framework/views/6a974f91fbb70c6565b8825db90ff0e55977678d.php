...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name')); ?>">
                                            ...
                                            <div class="col-xl-12">
                                                <div class="form-group">
                                                    <?php if($i == 1): ?>
                                                    <label for="<?php echo e($language->id); ?>.description">Description</label><span class="text-danger"> * </span>
                                                    <textarea id="body_<?php echo e($language->id); ?>.description" name="data[<?php echo e($language->id); ?>][description]" class="form-control form-control-solid form-control-lg  <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" rows="6"><?php echo e(old('description')); ?></textarea>
                                                    ...
                                                    <?php else: ?>
                                                    <label for="<?php echo e($language->id); ?>.description">Description</label><span class="text-danger"> </span>
                                                    <textarea id="body_<?php echo e($language->id); ?>.description" name="data[<?php echo e($language->id); ?>][description]" class="form-control form-control-solid form-control-lg "  rows="6"><?php echo e(old('description')); ?></textarea>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zaz/web/zaz.dev.obdemo.com/public_html/resources/views/admin/product/add.blade.php ENDPATH**/ ?>