            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        <?php echo e(Config('constants.CATEGORY.CATEGORY_TITLES')); ?>
                        ...
                        <div class="card card-custom card-stretch card-shadowless">
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <a href="<?php echo e(route($model.'.create')); ?>" class="btn btn-primary"> <?php echo e(trans("Add New ")); ?> <?php echo e(Config('constants.CATEGORY.CATEGORY_TITLE')); ?> </a>
                                </div>
                            </div>
                            <div class="card-body">
                                        ...
                                        <table class="table dataTable table-head-custom table-head-bg table-borderless table-vertical-center" id="taskTable">
                                            ...
                                            <tbody id="powerwidgets">
                                                ...
                                                <tr class="items-inner-sort" data-id = "<?php echo e($result->id); ?>">
                                                    <td><img src="<?php echo e(url (Config::get('constants.IMAGE_PATH'))); ?>Menu.svg" alt="" width="20">
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="text-right pr-2">
                                                        ...
                                                        <a  class="my-1 btn btn-primary" href="<?php echo e(route('sub-category.index',['encatid'=>base64_encode($result->id)])); ?>"><?php echo e(Config('constants.SUB_CATEGORY.SUB_CATEGORY_TITLES')); ?></a>
                                                    </td>
                                                </tr>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zaz/web/zaz.dev.obdemo.com/public_html/resources/views/admin/category/index.blade.php ENDPATH**/ ?>