											...
											<div class="card-body">
												<div class="">
													...
													<div class="row">
														...
														<div class="col-auto mb-5">
															<label class="checkbox">
																<input type="checkbox" name="data[<?php echo e($counter); ?>][module][<?php echo e($module_counter); ?>][value]" value=1 id="<?php echo e($aclModule->id); ?>" class="children child.<?php echo e($aclModule->id); ?>" <?php echo e(($module->active == 1) ? 'checked' : ''); ?>>
												...
												<div class="row">
													...
													<div class="card mb-5 border-0 col-auto">
														<label class="checkbox">
															<input id="<?php echo e($aclModule->id); ?>" type="checkbox" name="data[<?php echo e($counter); ?>][module][<?php echo e($module_counter); ?>][value]" value=1 class="children child.<?php echo e($aclModule->id); ?>" <?php echo e(($parentModule->active == 1) ?  'checked' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zaz/web/zaz.dev.obdemo.com/public_html/resources/views/admin/designations/edit.blade.php ENDPATH**/ ?>