            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        <?php echo e(Config('constants.SIZE.SIZE_TITLES')); ?>
                        ...
                        <div class="card card-custom card-stretch card-shadowless">
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <a href="<?php echo e(route($model.'.create')); ?>" class="btn btn-primary"> <?php echo e(trans("Add New ")); ?> <?php echo e(Config('constants.SIZE.SIZE_TITLE')); ?> </a>
                                </div>
                            </div>
                            <div class="card-body">
                                                        ...
                                                        <tbody id="powerwidgets">
                                                            ...
                                                            <tr class="items-inner-sort">
                                                                ...
                                                                <td class="text-right pr-2">
                                                                    ...
                                                                    <a href="<?php echo e(route($model.'.delete',['ensizid'=>base64_encode($result->id)])); ?>" class="btn btn-icon btn-light btn-hover-danger btn-sm confirmDelete" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="Delete" data-original-title="Delete">
                                                                        <span class="svg-icon svg-icon-md svg-icon-danger">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                                    <rect x="0" y="0" width="24" height="24" />
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zaz/web/zaz.dev.obdemo.com/public_html/resources/views/admin/size/index.blade.php ENDPATH**/ ?>