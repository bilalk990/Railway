...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
		...
		<div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				...
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					...
					Add New  <?php echo e(Config('constants.SEO.SEO_TITLE')); ?> </h5>
					<!--end::Page Title-->
	...
	<div class="d-flex flex-column-fluid">
		...
		<div class=" container ">
			...
			<?php echo e(Form::open(['role' => 'form','url' => 'adminpnlx/seo-page-manager/add-doc','class' => 'mws-form','enctype'=> 'multipart/form-data',"autocomplete"=>"off"])); ?>
								...
								<div class="row">
									<div class="col-xl-6">
										...
										<div class="form-group">
											...
											<?php echo e(Form::text("page_id",'', ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('page_id') ? 'is-invalid':'')])); ?>
									...
									<div class="col-xl-6">
										...
										<div class="form-group">
											...
											<?php echo e(Form::text("page_name",'', ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('page_name') ? 'is-invalid':'')])); ?>
										...
										<div class="col-xl-6">
											...
											<div class="form-group">
												...
												<?php echo e(Form::text("title",'', ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('title') ? 'is-invalid':'')])); ?>
										...
										<div class="col-xl-6">
											...
											<div class="form-group">
												...
												<?php echo e(Form::textarea("meta_keywords",'', ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('meta_keywords') ? 'is-invalid':''),"rows"=>false,"cols"=>false])); ?>
										...
										<div class="col-xl-6">
											...
											<div class="form-group">
												...
												<?php echo e(Form::textarea("twitter_card",'', ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('twitter_card') ? 'is-invalid':''),"rows"=>false,"cols"=>false])); ?>
										...
										<div class="col-xl-6">
											...
											<div class="form-group">
												...
												<?php echo e(Form::textarea("twitter_site",'', ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('twitter_site') ? 'is-invalid':''),"rows"=>false,"cols"=>false])); ?>
										...
										<div class="col-xl-6">
											...
											<div class="form-group">
												...
												<?php echo e(Form::textarea("og_url",'', ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('og_url') ? 'is-invalid':''),"rows"=>false,"cols"=>false])); ?>
										...
										<div class="col-xl-6">
											...
											<div class="form-group">
												...
												<?php echo e(Form::textarea("og_type",'', ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('og_type') ? 'is-invalid':''),"rows"=>false,"cols"=>false])); ?>
										...
										<div class="col-xl-6">
											...
											<div class="form-group">
												...
												<?php echo e(Form::textarea("og_title",'', ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('og_title') ? 'is-invalid':''),"rows"=>false,"cols"=>false])); ?>
										...
										<div class="col-xl-6">
											...
											<div class="form-group">
												...
												<?php echo e(Form::textarea("og_description",'', ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('og_description') ? 'is-invalid':''),"rows"=>false,"cols"=>false])); ?>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zaz/web/zaz.dev.obdemo.com/public_html/resources/views/admin/SeoPage/add.blade.php ENDPATH**/ ?>